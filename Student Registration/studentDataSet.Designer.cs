...
namespace Student_Registration {
    ...
    public partial class studentDataSet : global::System.Data.DataSet {
        ...
        public partial class studentsDataTable : global::System.Data.TypedTableBase<studentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentsRow AddstudentsRow(int id, string name, string phone, string blood, string gender, string email, string dob, string description, System.DateTime createdAt, int createdBy, int updatedBy) {
        ...
        public partial class studentsRow : global::System.Data.DataRow {
            ...
            public string blood {
                get {
                    return ((string)(this[this.tablestudents.bloodColumn]));
                }
                set {
                    this[this.tablestudents.bloodColumn] = value;
                }
            }
            ...
            public string description {
                get {
                    return ((string)(this[this.tablestudents.descriptionColumn]));
                }
                set {
                    this[this.tablestudents.descriptionColumn] = value;
                }
            }
...
namespace Student_Registration.studentDataSetTableAdapters {
    ...
    public partial class adminTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@IsNull_updatedAt";
            param.DbType = global::System.Data.DbType.Int32;
            param.SqlDbType = global::System.Data.SqlDbType.Int;
            param.IsNullable = true;
...
SELECT id, name, phone, username, password, createdAt, updatedAt FROM admin WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student_Registration.Properties.Settings.Default.studentConnectionString;
        }
    ...
    public partial class studentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::Microsoft.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[students] ([id], [name], [phone], [blood], [gender], [email], " +
                "[dob], [description], [createdAt], [createdBy], [updatedBy]) VALUES (@id, @name," +
                " @phone, @blood, @gender, @email, @dob, @description, @createdAt, @createdBy, @u" +
                "pdatedBy)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            global::Microsoft.Data.SqlClient.SqlParameter param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@id";
            ...
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
            param.ParameterName = "@blood";
            param.DbType = global::System.Data.DbType.AnsiString;
            param.SqlDbType = global::System.Data.SqlDbType.VarChar;
            param.IsNullable = true;
            param.SourceColumn = "blood";
            this._adapter.InsertCommand.Parameters.Add(param);
            param = new global::Microsoft.Data.SqlClient.SqlParameter();
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::Microsoft.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, name, phone, blood, gender, email, dob, description, createdAt, create" +
                "dBy, updatedBy FROM dbo.students";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int id, string name, string phone, string blood, string gender, string email, string dob, string description, System.DateTime createdAt, int createdBy, global::System.Nullable<int> updatedBy) {
